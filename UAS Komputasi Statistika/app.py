...
st.image("./.notebook/assets/images/Alur Flowchart.jpg", caption= "Flowchart Simulasi Data Monte Carlo Simulation, Markov Chain, dan Hidden Markov Model pada Sleep & Lifestyle Study")
