...
st.write(df.describe().style.set_properties(**{"background-color": "white", "color": "black"}))
...
sleep_quality_counts.plot(kind='bar', ax=ax2, color='black')
ax2.set_title("Distribusi Kualitas Tidur")
ax2.set_xlabel("Rating Kualitas Tidur")
...
stress_level_counts = df["Stress Level"].value_counts().sort_index()
stress_level_counts.plot(kind='bar', ax=ax4, color='black')
ax4.set_title("Distribusi Tingkat Stres")
ax4.set_xlabel("Level Stres")
...
fig2, ax2 = plt.subplots() 
sns.countplot(x="Quality of Sleep", data=df, ax=ax2, palette="black")
ax2.set_title("Distribusi Kualitas Tidur:")
st.pyplot(fig2)
...
fig4, ax4 = plt.subplots() # Membuat diagram batang untuk variabel Tingkat Stres dalam dataset
sns.countplot(x="Stress Level", data=df, ax=ax4, palette="black")
ax4.set_title("Distribusi Tingkat Stres:")
st.pyplot(fig4)
...
st.dataframe(df[["Sleep Duration", "Sleep Category"]].head(11).style.set_properties(**{"background-color": "white", "color": "black"}))
'''
# Buat Kategori Tidur dari Variabel Durasi Tidur
...
st.dataframe(df[["Sleep Duration", "Sleep Category"]].head(11).style.set_properties(**{"background-color": "white", "color": "black"})) # Menampilkan 10 baris pertama dari dataframe yang berisi kolom "Sleep Duration" dan "Sleep Category"
...
st.write(simulasi_durasi_tidur)
st.write(simulasi_aktivitas_fisik)
st.write(simulasi_tingkat_stres)

# Visualisasi Data Monte Carlo
...
st.write(df[["Sleep Duration", "Physical Activity Level", "Stress Level", "Hidden State"]].head(11).style.set_properties(**{"background-color": "white", "color": "black"}))
...
st.write(df[["Sleep Duration", "Physical Activity Level", "Stress Level", "Hidden State"]].head(11).style.set_properties(**{"background-color": "white", "color": "black"})) # Menampilkan 10 baris pertama dari dataframe yang berisi kolom "Sleep Duration", "Physical Activity Level", "Stress Level", dan "Hidden State"
