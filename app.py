...
st.dataframe(df[["Sleep Duration", "Sleep Category"]].head(11)) # Menampilkan 10 baris pertama dari dataframe yang berisi kolom "Sleep Duration" dan "Sleep Category"
...
st.write(df[["Sleep Duration", "Physical Activity Level", "Stress Level", "Hidden State"]].head(11)) # Menampilkan 10 baris pertama dari dataframe yang berisi kolom "Sleep Duration", "Physical Activity Level", "Stress Level", dan "Hidden State"
