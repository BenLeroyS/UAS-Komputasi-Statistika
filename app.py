...
st.write(df.isnull().sum().style.set_properties(**{"background-color": "white", "color": "black"}))
...
# Tampilkan kode
st.code(EDA, language="python".style.set_properties(**{"background-color": "white", "color": "black"}))
