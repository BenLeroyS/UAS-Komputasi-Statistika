...
sns.countplot(x="Quality of Sleep", data=df, ax=ax2, color="black")
...
sns.countplot(x="Stress Level", data=df, ax=ax4, color="black")
...
fig2, ax2 = plt.subplots() # Membuat diagram batang untuk variabel Kualitas Tidur dalam dataset
sns.countplot(x="Quality of Sleep", data=df, ax=ax2, color="black")
ax2.set_title("Distribusi Kualitas Tidur:")
st.pyplot(fig2)
